...
class InitialiseToolbox(object):
    ...
    def __init__(self):
        self.label = u'00 Initialise toolbox'
    ...
    def getParameterInfo(self):
        ...
        param.displayName = u'Scratch path (folder which will contain intermediate files)'
    ...
    def execute(self, parameters, messages):
        ...
        import NB_EE.tools.t_initialise_toolbox as t_initialise_toolbox
        refresh_modules(t_initialise_toolbox)

        t_initialise_toolbox.function(parameters)
